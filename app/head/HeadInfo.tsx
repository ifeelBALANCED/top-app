...
const getHeadTags = () => {
  ...
  return {
    ...
    favicon: document.querySelector<HTMLLinkElement>(`link[rel="shortcut icon"]`)?.href || ''
  }
}
...
export function HeadInfo() {
  ...
  return (
    <Boundary size='small' labels={['Configured <head> tags']} color='blue' animateRerendering={false}>
