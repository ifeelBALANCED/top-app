    ...
    <div className='space-y-4'>
      ...
      <div className='space-y-4'>
        <ul className='list-disc space-y-2 pl-4 text-sm text-gray-300'>
          ...
          <li>
            Try incrementing the counter and navigating between pages. Note how the counter state is shared across the
            app even though they are inside different layouts and pages that are Server Components.
          </li>
        </ul>
      </div>
