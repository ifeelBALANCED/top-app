...
export const ProductCard = ({ product, href }: { product: IProduct; href: string }) => {
  ...
  return (
    <Link href={href} className='group block'>
      <div className='space-y-2'>
        ...
        <div className='truncate text-sm font-medium text-white group-hover:text-vercel-pink'>{product.name}</div>
